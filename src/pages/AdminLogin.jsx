      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-lg shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-semibold mb-2" htmlFor="admin-email">
                Admin Email
              </label>
              <input
                id="admin-email"
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            <p>Not an admin?</p>
            <Link to="/" className="mt-2 inline-block text-purple-700 font-semibold hover:underline">
              User Login
            </Link>
          </div>
        </div>
        ...
        <div className="text-center mt-6 text-purple-200 text-sm">
          &copy; 2026 Erostar Star Enterprises. All rights reserved.
        </div>
      </div>
    </div>
  );
